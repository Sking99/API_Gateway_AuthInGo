...
func (r *RoleRepositoryImpl) GetRoleById(id int64) (*models.Role, error) {
	...
	role := &models.Role{}
	if err := row.Scan(&role.Id, &role.Name, &role.Description, &role.Created_at, &role.Updated_at); err != nil {
		return nil, err
	}
	return role, nil
}
...
func (r *RoleRepositoryImpl) GetRoleByName(name string) (*models.Role, error) {
	...
	role := &models.Role{}
	if err := row.Scan(&role.Id, &role.Name, &role.Created_at, &role.Updated_at); err != nil {
		return nil, err
	}
	return role, nil
}
